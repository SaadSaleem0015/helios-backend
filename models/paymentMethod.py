...
class PaymentMethod(Model):
    ...
    user = fields.ForeignKeyField("models.User", related_name="paymentMethod")  
    ...
    stripe_customer_id = fields.TextField( null=True)
    payment_method_id = fields.TextField( null=True)  
    created_at = fields.DatetimeField(auto_now_add=True)
    phone_number = fields.CharField(max_length=15, null=True)  
    email = fields.CharField(max_length=255, null=True) 
    is_primary = fields.BooleanField(default=False , null = True)  
