...
class PurchasedNumber(Model):
    ...
    # attached_assistant_uuid = fields.TextField(null = True)
    vapi_phone_uuid = fields.CharField(max_length=255, null=True, default=None)

    # New fields for CNAM integration
    # assigned_to_cnam = fields.BooleanField(default=False)
    # cnam_status = fields.CharField(max_length=20, null=True)  # e.g., 'pending', 'active', 'failed'
